...
using BlindMatchPAS.Infrastructure.Repositories;
...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlServer(connectionString, b => b.MigrationsAssembly("BlindMatchPAS.Infrastructure")));
...
builder.Services.AddScoped<ISupervisorExpertiseRepository, SupervisorExpertiseRepository>();
